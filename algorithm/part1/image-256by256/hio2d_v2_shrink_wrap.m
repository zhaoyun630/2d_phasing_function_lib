...
% support 2x
% support = importdata('support_from_acf_2x.mat');
% support = importdata('support_cd_2x.mat');
% support = importdata('support_from_pf_1x.mat');
% support = importdata('support_from_half_acf_1x.mat');
support = importdata('support_2x_square.mat');
