...
% Last editted by Yun Zhao on May 29th, 2015
% 
% Compared with V2, this version doesn't take reflection list from experimental
% , but from a model which has all positive charges.
% *************************************************************************
%% Notation:
...
RPhaseCCPlot2(figureOfMerit,runID);
