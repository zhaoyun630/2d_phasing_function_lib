...
for cycle = 1:iter_big_cycle
    ...
    obj_intermediate_name = strcat('obj_estimate_',int2str(cycle),'_intermediate_',parameter_name,'.mat');
...
saveas(plt2,'F_000_1A_79_3_100_3_40_10_1.tif');
