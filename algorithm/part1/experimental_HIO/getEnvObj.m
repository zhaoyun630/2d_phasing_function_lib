...
% Input parameter
obj = importdata('unitCellRealShift0Res3A.mat');
filterFrac = 0.01;
objThreshold = 0.8;
envThreshold = 0.5;
inputID = 1;
...
guassianSigma = 9; % The unit is the half length of Guassian filter.
...
thresholdDensity = sortDensity(round(objThreshold*totalPixel)+1);
