% ######################################################################
%  HIO alogrithm given with a molecular envelope
% ######################################################################
%% Version
% First Created by Yun Zhao on Feb 13rd, 2015
% Last editted by Yun Zhao on Mar 29th, 2016
% 
% Compared with shrinkwrapEnv_v1_*.m or shrinkwrapEnv.m, This version takes object in unit
% cell to calculate CC and R factor. In additional, it calculate phase
% error in angle.
% *************************************************************************
%% Notation:
...
figureOfMerit(iterIndex,5) = getwPhaseError_v2(model_s_angle,objIter_s_phase,model_s_abs,objIter_s_abs,HKLmask);
